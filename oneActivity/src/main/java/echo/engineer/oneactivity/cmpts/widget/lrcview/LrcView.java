package echo.engineer.oneactivity.cmpts.widget.lrcview;
...
import echo.engineer.oneactivity.cmpts.widget.lrcview.bean.LrcBean;
import echo.engineer.oneactivity.cmpts.widget.lrcview.util.LrcUtil;
...
public class LrcView extends View {
    ...
    public LrcView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        highLineColor = ta.getColor(R.styleable.LrcView_hignLineColor, getResources().getColor(R.color.lrcview_green));
