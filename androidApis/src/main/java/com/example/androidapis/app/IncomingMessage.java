...
//BEGIN_INCLUDE(intent_array)
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(context,
                com.example.androidapis.ApiDemos.class));

        // "App"
        intents[1] = new Intent(context, com.example.androidapis.ApiDemos.class);
        intents[1].putExtra("com.example.androidapis.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, com.example.androidapis.ApiDemos.class);
        intents[2].putExtra("com.example.androidapis.Path", "App/Notification");
