...
//BEGIN_INCLUDE(intent_array)
    private Intent[] buildIntentsToViewsLists() {
        ...
        intent.setClass(IntentActivityFlags.this, com.example.androidapis.ApiDemos.class);
        intent.putExtra("com.example.androidapis.Path", "Views");
        intents[1] = intent;

        intent = new Intent(Intent.ACTION_MAIN);
        intent.setClass(IntentActivityFlags.this, com.example.androidapis.ApiDemos.class);
        intent.putExtra("com.example.androidapis.Path", "Views/Lists");
