...
public class SmsReceivedDialog extends Activity implements OnInitListener {
    ...
    public static final String SMS_FROM_ADDRESS_EXTRA = "com.example.androidapis.os.SMS_FROM_ADDRESS";
    public static final String SMS_FROM_DISPLAY_NAME_EXTRA = "com.example.androidapis.os.SMS_FROM_DISPLAY_NAME";
    public static final String SMS_MESSAGE_EXTRA = "com.example.androidapis.os.SMS_MESSAGE";
