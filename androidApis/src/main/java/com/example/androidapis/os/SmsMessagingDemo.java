...
package com.example.androidapis.os;
...
public class SmsMessagingDemo extends Activity {
    ...
    public static final String SMS_RECIPIENT_EXTRA = "com.example.androidapis.os.SMS_RECIPIENT";

    public static final String ACTION_SMS_SENT = "com.example.androidapis.os.SMS_SENT_ACTION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ComponentName componentName = new ComponentName("com.example.androidapis",
                "com.example.androidapis.os.SmsMessageReceiver");
