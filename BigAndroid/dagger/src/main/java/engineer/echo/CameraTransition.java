...
public class CameraTransition extends Transition {
    ...
    private int mColor = Color.parseColor("#33589d");
...
//                //TODO 判断退出
//                int w = endView.getResources().getDisplayMetrics().widthPixels;
//                if (w == endView.getWidth()) {
//                    endView.setAlpha(1f);
//                }
//            }
//        });
