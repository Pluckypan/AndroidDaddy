...
public class RoundAngleFrameLayout extends FrameLayout {
    ...
    public RoundAngleFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            float radius = ta.getDimension(R.styleable.RoundAngleFrameLayout_rf_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_rf_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_rf_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_rf_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_rf_bottomRightRadius, radius);
            ta.recycle();
        }
